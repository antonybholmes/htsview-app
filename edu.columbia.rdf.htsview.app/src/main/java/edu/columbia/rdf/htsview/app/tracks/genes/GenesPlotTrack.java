...
public abstract class GenesPlotTrack extends AnnotationPlotTrack {
   ...
   * (non-Javadoc)
   * 
   * @see edu.columbia.rdf.htsview.tracks.Track#edit(org.abh.common.ui.window.
   * ModernWindow)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see edu.columbia.rdf.htsview.tracks.AnnotationPlotTrack#toXml(org.w3c.dom.
   * Document)
   */
  @Override
   ...
   * 
   * @see
   * edu.columbia.rdf.htsview.tracks.AnnotationPlotTrack#toJson(org.abh.common.
   * json.JsonBuilder)
   */
  @Override
