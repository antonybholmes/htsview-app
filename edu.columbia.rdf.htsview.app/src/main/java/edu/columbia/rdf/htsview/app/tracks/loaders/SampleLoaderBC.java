...
import edu.columbia.rdf.htsview.tracks.sample.SampleAssemblyBC;

/**
 * The Class SampleLoaderBAM.
 */
public class SampleLoaderBC extends SampleLoaderBinary {
  ...
  public Track openSample(ModernWindow parent,
    ...
    return openSampleFs(sample, new SampleAssemblyBC(file), file, root);
  }
}
